...
public class AddressBookWindow extends JFrame implements ActionListener, PersonListener {
	...
	private JMenuItem baru, open, save, saveAs, print, quit, aboutUs;
	...
	private void buatFile() {
		...
		baru = new JMenuItem("New");
		baru.setFont(f2);
		baru.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_N, 
